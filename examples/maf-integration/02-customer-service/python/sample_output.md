# Sample Output — Contoso Support Governance Demo (Python)
...
> may vary slightly depending on the random seed and timing, but the overall
> pattern (escalating Z-scores, dropping entropy, quarantine trigger) will be
> consistent.
