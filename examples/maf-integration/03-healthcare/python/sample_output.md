# MedAssist — HIPAA Patient Data Governance Demo — Sample Output

Below is representative terminal output (ANSI codes stripped) from running `python main.py` in simulated mode.
...
━━━ Act 2: Capability Sandboxing ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  ✅ check_drug_interactions()  →  {"drug_a": "warfarin", "drug_b": "aspirin", "interaction_level": "HIGH", "descri...
  ✅ get_treatment_guidelines()  →  {"condition": "hypertension", "guideline_source": "JNC-8 / AHA 2023", "first_l...
  ❌ access_patient_record()  →  BLOCKED by capability policy
  ❌ prescribe_medication()  →  Blocked: Controlled substance 'oxycodone' requires physician override
